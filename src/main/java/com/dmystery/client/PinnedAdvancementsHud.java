...
public class PinnedAdvancementsHud implements HudRenderCallback {
    ...
    public void onHudRender(GuiGraphics graphics, DeltaTracker deltaTracker) {
        ...
        for (ResourceLocation id : pinnedList) {
            ...
            graphics.renderItem(icon, x + 3, iconY);
            ...
            for (FormattedCharSequence tLine : splitTitle) {
                graphics.drawString(font, tLine, x + 21, textY, titleColor, true);
                textY += 9;
            }
            ...
            if (!splitDesc.isEmpty()) {
                for (FormattedCharSequence dLine : splitDesc) {
                    graphics.drawString(font, dLine, x + 21, textY, descColor, true);
                    textY += 9;
                }
            } else {
            ...
            if (isComposite) {
                ...
                graphics.drawString(font, progLabel, x + 21, textY, 0xFFAAAAAA, true);
                textY += 9;
